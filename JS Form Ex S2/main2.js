...
function createAnAccount() {
  ...
  if (email1 == email2) {
    alert("Thank You " + name +"! Your account has been registered correctly.");
  }
  else {
    alert("Sorry, unable to process your account. Please review password input.Results do not match");
